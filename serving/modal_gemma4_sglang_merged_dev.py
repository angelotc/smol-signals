"""Smoke-test the merged Smol Signals Gemma 4 model on Modal with SGLang.
...
Run:
    ...
    modal run serving/modal_gemma4_sglang_merged_dev.py --limit 1
"""
...
APP_NAME = "smol-signals-gemma4-sglang-merged-dev"
MERGED_MODEL = "build-small-hackathon/small-signals-gemma-4-12b-sft-merged"
...
def _start_server() -> subprocess.Popen:
    ...
    print("Starting merged SGLang Gemma 4 dev server:", flush=True)
...
def main(
    ...
    output_path: str = "training/output/sglang_gemma4_merged_eval.json",
) -> None:
    ...
    print(f"Merged SGLang Gemma 4 dev URL: {base_url}", flush=True)
